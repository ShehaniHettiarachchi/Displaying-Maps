...
public class HelloWorld extends PApplet
{
	...
	public void setup() {
		...
		map1 = new UnfoldingMap(this, 50, 50, 850, 500, provider);

		// The next line zooms in and centers the map at 
	    // 32.9 (latitude) and -117.2 (longitude) --> location La Jolla
		//location change to colombo
	    map1.zoomAndPanTo(zoomLevel, new Location(6.927079f, 79.861244f));
